...
// REPOSITÓRIO DE PUBLICACÕES
type Publicacoes struct {
	db *sql.DB
}

// CRIAR UM REPOSITÓRIO DE PUBLICAÇÕES
func NovoRepositorioDePublicacoes(db *sql.DB) *Publicacoes {
	return &Publicacoes{db}
}

// INSERE UMA PUBLICAÇÃO NO BD
...
// Traz uma única publicação do BD
...
// Altera os dados de uma publicação no BD
