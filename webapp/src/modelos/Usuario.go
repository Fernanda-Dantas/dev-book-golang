...
// Chama a API para buscar os dados base do usuário
...
// Chama a API para buscar os seguidores do usuário
...
// Chama a API para buscar os usuários seguidos por um usuário
...
// Busca as publicações de um usuário
