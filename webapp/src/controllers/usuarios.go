...
// Chama a API para cadastrar um usuário no BD
...
// Chama a API para parar de seguir um usuário no BD
...
// Chama a API para seguir um usuário no BD
...
func AtualizarSenha(w http.ResponseWriter, r *http.Request) {
	...
	senhas, erro := json.Marshal(map[string]string{
		"atual": r.FormValue("senha"),
		"nova":  r.FormValue("nova-senha"),
	})
	if erro != nil {
		respostas.JSON(w, http.StatusBadRequest, respostas.ErroAPI{Erro: erro.Error()})
		return
